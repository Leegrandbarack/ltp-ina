...
export const HeroSection = () => (
  <section className="relative min-h-screen flex items-center overflow-hidden">
    ...
    <div className="absolute inset-0 bg-primary">
      ...
      <div className="absolute top-20 left-1/3 w-2 h-2 bg-gold rounded-full animate-pulse" />
      <div className="absolute bottom-40 right-1/4 w-1.5 h-1.5 bg-accent rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
    </div>
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 text-primary-foreground/50 font-body text-sm mb-10 animate-fade-in-up" style={{ animationDelay: '0.55s' }}>
            ...
            <span>Ina, Bembéréké — Borgou, Bénin</span>
          </div>
        ...
        <div className="hidden lg:block animate-fade-in-up" style={{ animationDelay: '0.9s' }}>
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-card text-card-foreground rounded-xl p-4 shadow-elevated flex items-center gap-3">
              ...
              <div>
                <p className="font-display font-bold text-sm">850+</p>
                <p className="font-body text-xs text-muted-foreground">Élèves formés</p>
              </div>
            </div>
